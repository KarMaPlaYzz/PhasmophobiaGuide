...
export const GHOSTS: Record<string, Ghost> = {
  ...
  phantom: {
    ...
    recommendedEquipment: {
      essential: ['Spirit Box', 'UV Light', 'D.O.T.S. Projector'],
  ...
  poltergeist: {
    ...
    recommendedEquipment: {
      essential: ['Spirit Box', 'UV Light', 'Ghost Writing Book'],
      recommended: ['Crucifix', 'Sanity Medication', 'Body Armor'],
  ...
  banshee: {
    ...
    recommendedEquipment: {
      essential: ['D.O.T.S. Projector', 'UV Light', 'Video Camera'],
      recommended: ['Crucifix', 'Sanity Medication', 'Head Gear'],
  ...
  jinn: {
    ...
    recommendedEquipment: {
      essential: ['EMF Reader', 'UV Light', 'Thermometer'],
      recommended: ['Crucifix', 'Sanity Medication', 'Breaker Key'],
  ...
  mare: {
    ...
    recommendedEquipment: {
      essential: ['Video Camera', 'Ghost Writing Book', 'Spirit Box'],
      recommended: ['Flashlight', 'Sanity Medication', 'Flares'],
      optional: ['Head Gear', 'Thermometer'],
      avoid: [],
    },
  ...
  revenant: {
    ...
    recommendedEquipment: {
      essential: ['Video Camera', 'Ghost Writing Book', 'Thermometer'],
      recommended: ['Crucifix', 'Sanity Medication', 'Body Armor'],
      optional: ['Head Gear', 'EMF Reader'],
      avoid: [],
    },
    huntSanityThreshold: 50,
    movementSpeed: 'Variable',
  ...
  shade: {
    ...
    recommendedEquipment: {
      essential: ['EMF Reader', 'Ghost Writing Book', 'Thermometer'],
      recommended: ['Crucifix', 'Sanity Medication', 'Video Camera'],
  ...
  demon: {
    ...
    recommendedEquipment: {
      essential: ['UV Light', 'Ghost Writing Book', 'Thermometer'],
      recommended: ['Crucifix', 'Sanity Medication', 'Body Armor'],
  ...
  yurei: {
    ...
    recommendedEquipment: {
      essential: ['D.O.T.S. Projector', 'Video Camera', 'Thermometer'],
      recommended: ['Sanity Medication', 'Crucifix', 'Head Gear'],
  ...
  oni: {
    ...
    recommendedEquipment: {
      essential: ['EMF Reader', 'D.O.T.S. Projector', 'Thermometer'],
      recommended: ['Crucifix', 'Sanity Medication', 'Video Camera'],
  ...
  yokai: {
    ...
    recommendedEquipment: {
      essential: ['D.O.T.S. Projector', 'Video Camera', 'Spirit Box'],
      recommended: ['UV Light', 'Thermometer', 'Head Gear'],
  ...
  hantu: {
    ...
    recommendedEquipment: {
      essential: ['UV Light', 'Video Camera', 'Thermometer'],
      recommended: ['Thermometer', 'Head Gear', 'Sanity Medication'],
      optional: ['EMF Reader', 'Spirit Box'],
      avoid: [],
    },
    huntSanityThreshold: 50,
  ...
  goryo: {
    ...
    recommendedEquipment: {
      essential: ['EMF Reader', 'D.O.T.S. Projector', 'UV Light'],
  ...
  myling: {
    ...
    recommendedEquipment: {
      essential: ['EMF Reader', 'UV Light', 'Ghost Writing Book'],
  ...
  onryo: {
    ...
    recommendedEquipment: {
      essential: ['Video Camera', 'Spirit Box', 'Thermometer'],
      recommended: ['Flashlight', 'Head Gear', 'Sanity Medication'],
  ...
  theTwins: {
    ...
    recommendedEquipment: {
      essential: ['EMF Reader', 'Spirit Box', 'Thermometer'],
  ...
  raiju: {
    ...
    recommendedEquipment: {
      essential: ['EMF Reader', 'D.O.T.S. Projector', 'Video Camera'],
      recommended: ['Head Gear', 'Thermometer', 'Sanity Medication'],
  ...
  obake: {
    ...
    recommendedEquipment: {
      essential: ['EMF Reader', 'UV Light', 'Video Camera'],
      recommended: ['Head Gear', 'Ghost Writing Book', 'Thermometer'],
      optional: ['D.O.T.S. Projector', 'Spirit Box'],
      avoid: [],
    },
    huntSanityThreshold: 50,
  ...
  theMinic: {
    ...
    recommendedEquipment: {
      essential: ['UV Light', 'Spirit Box', 'Thermometer'],
      recommended: ['Video Camera', 'EMF Reader', 'Head Gear'],
  ...
  moroi: {
    ...
    recommendedEquipment: {
      essential: ['Spirit Box', 'UV Light', 'Thermometer'],
  ...
  thaye: {
    ...
    recommendedEquipment: {
      essential: ['Video Camera', 'Ghost Writing Book', 'D.O.T.S. Projector'],
      recommended: ['D.O.T.S. Projector', 'Head Gear', 'Sanity Medication'],
      optional: ['EMF Reader', 'Spirit Box'],
      avoid: [],
    },
    huntSanityThreshold: 50,
